...
export function CellphoneCookie() {
  return (
    <div className="bg-gray-100 w-screen flex flex-col items-center">
      ...
      <div className="w-5/6 h-full my-20 flex flex-col text-left gap-4">
        ...
        <ul className="marker:text-red-600 text-poppins text-base font-normal text-gray-800 list-disc pl-5">
          <li className="my-3">
            <span className="font-bold text-red-600">proprietary cookies</span>: used solely
        ...
        <ul className="marker:text-red-600 text-poppins text-base font-normal text-gray-800 list-disc pl-5">
          ...
          <li className="my-3">
            <span className="font-bold text-red-600">profiling</span>: subject to and created
